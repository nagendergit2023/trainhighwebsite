        ...
        <section className="bg-black text-white py-lg-5 py-3 trainings">
            ...
            <Container>
                <Row className="justify-content-center">
                    ...
                    <Col xs={6} md={6} lg={4} className='mb-lg-4 mb-3 position-relative wow animate__fadeInUp' data-wow-delay="0.1s">
                    ...
                    <Col xs={6} md={6} lg={4} className='mb-lg-4 mb-3 position-relative wow animate__fadeInUp' data-wow-delay="0.2s">
                    ...
                    <Col xs={6} md={6} lg={4} className='mb-lg-4 mb-3 position-relative wow animate__fadeInUp' data-wow-delay="0.3s">
                    ...
                    <Col xs={6} md={6} lg={4} className='mb-lg-4 mb-3 position-relative wow animate__fadeInUp' data-wow-delay="0.4s">
                    ...
                    <Col xs={6} md={6} lg={4} className='mb-lg-4 mb-3 position-relative wow animate__fadeInUp' data-wow-delay="0.5s">
                    ...
                    <Col xs={6} md={6} lg={4} className='mb-lg-4 mb-3 position-relative wow animate__fadeInUp' data-wow-delay="0.6s">
                    ...
                    <Col xs={6} md={6} lg={4} className='mb-lg-4 mb-3 position-relative wow animate__fadeInUp' data-wow-delay="0.7s">
                    ...
                    <Col xs={6} md={6} lg={4} className='mb-lg-4 mb-3 position-relative wow animate__fadeInUp' data-wow-delay="0.8s">
                    ...
                    <Col xs={6} md={6} lg={4} className='mb-lg-4 mb-3 position-relative wow animate__fadeInUp' data-wow-delay="0.9s">
                    ...
                    <Col xs={6} md={6} lg={4} className='mb-lg-4 mb-3 position-relative wow animate__fadeInUp' data-wow-delay="1.0s">
                    ...
                    <Col xs={6} md={6} lg={4} className='mb-lg-4 mb-3 position-relative wow animate__fadeInUp' data-wow-delay="1.1s">
                    ...
                    <Col xs={6} md={6} lg={4} className='mb-lg-4 mb-3 position-relative wow animate__fadeInUp' data-wow-delay="1.2s">
