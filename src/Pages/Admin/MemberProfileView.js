    ...
    <div className="container py-5">
      ...
      <div className="row align-items-center mb-4">
        <div className="col-md-4 text-center">
          ...
          />
          <h4 className="mt-3 fw-semibold text-primary">{customer.name}</h4>
        </div>
        ...
        <div className="col-md-8">
          <div className="p-3 bg-light rounded-3 shadow-sm">
            ...
            <p className="mb-2"><strong>Phone:</strong> {customer.phone}</p>
            <p className="mb-2"><strong>Membership:</strong> {customer.membershipType}</p>
          </div>
        </div>
      </div>
        ...
        <div className="accordion-item mt-2">
          ...
          >
            <div className="accordion-body">
              ...
              <p><strong>Goals:</strong> {customer.goals}</p>
              <p><strong>Trainer Assigned:</strong> {customer.trainer}</p>
            </div>
          </div>
        </div>
      ...
      <div className="text-center mt-5">
        <button className="btn btn-dark px-4 py-2 rounded-pill shadow-sm fw-semibold">
          Edit Profile
        </button>
      </div>
    </div>
