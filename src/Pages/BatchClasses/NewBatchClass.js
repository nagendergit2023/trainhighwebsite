                            ...
                            <Form onSubmit={handleSubmit}>
                                <Row>
                                    ...
                                    <Col lg={12} className="mb-4">
                                        ...
                                        <div className="d-flex gap-3 flex-wrap">
                                            {trainers.map((t) => (
                                                <div
                                                    key={t.id}
                                                    className={`badge-select ${selectedTrainers.includes(t.id) ? "active" : ""
                                                        }`}
                                                    onClick={() =>
                                                        toggleSelection(selectedTrainers, t.id, setSelectedTrainers)
                                                    }
                                                >
                                                    {t.name}
                                                </div>
                                    ...
                                    <Col lg={12} className="mb-4">
                                        ...
                                        <div className="d-flex gap-3 flex-wrap">
                                            {services.map((s) => (
                                                <div
                                                    key={s}
                                                    className={`badge-select ${selectedServices.includes(s) ? "active" : ""
                                                        }`}
                                                    onClick={() =>
                                                        toggleSelection(selectedServices, s, setSelectedServices)
                                                    }
                                                >
                                                    {s}
                                                </div>
                                    ...
                                    <Col lg={12} className="mb-4">
                                        ...
                                        <div className="d-flex flex-wrap" style={{ gap: "0.7rem" }}>
                                            {workingDays.map((d) => (
                                                <div
                                                    key={d}
                                                    className={`badge-select ${selectedDays.includes(d) ? "active" : ""
                                                        }`}
                                                    onClick={() =>
                                    ...
                                    <Col lg={4} className="mb-3">
                                        <FloatingLabel label="Start Time">
                                            <TimePicker
                                                ...
                                                onChange={(t) => setStartTime(t ? t.format("HH:mm") : null)}
                                            />
                                        </FloatingLabel>
                                    </Col>
                                    ...
                                    <Col lg={4} className="mb-3">
                                        <FloatingLabel label="End Time">
                                            <TimePicker
                                                ...
                                                onChange={(t) => setEndTime(t ? t.format("HH:mm") : null)}
                                            />
                                        </FloatingLabel>
                                    </Col>
                                    ...
                                    <Col lg={4} className="ms-auto my-2">
                                        <button className="btn btn-dark w-100 py-2 btn-lg" type="submit">
                                            Save Batch
                                        </button>
                                    </Col>
