...
function Footer() {
	return (
		<>
			<footer className="bg-black text-white pt-4 border-top" style={{ marginTop: "-8px" }}>
				<Container>
					<Row className="justify-content-center align-items-start py-4">
						<Col lg={4}>
							...
							<ul className="text-primary-hover mt-3 mt-md-0 list-unstyled ps-0">
								<li className="mb-1"><a className="text-light small text-uppercase" href="/trainings">Trainings</a></li>
								<li className="mb-1"><a className="text-light small text-uppercase" href="/events">Events</a></li>
								<li className="mb-1"><a className="text-light small text-uppercase" href="mailto:trainhighgym@gmail.com">Career</a></li>
								<li className="mb-1"><a className="text-light small text-uppercase" href="/contact-us">Contact us</a></li>
							</ul>
						</Col>
						<Col lg={4}>
							<p className="fw-bold">COMPANY</p>
							<ul className="text-primary-hover mt-3 mt-md-0 list-unstyled ps-0">
								<li className="mb-1"><a className="text-light small text-uppercase" href="/why-to-join">Why to Join</a></li>
								<li className="mb-1"><a className="text-light small text-uppercase" href="/franchise">Franchise</a></li>
								<li className="mb-1"><a className="text-light small text-uppercase" href="/frequently-asked-questions">FAQs</a></li>	
								<li className="mb-1"><a className="text-light small text-uppercase" href="/blogs">Blogs</a></li>							
							</ul>
						</Col>
						<Col lg={4}>
