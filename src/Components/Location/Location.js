...
function Location() {
    ...
    },
    {
      ...
      address: "Ground Floor, ESI-Basaidarapur Metro Station, New Delhi - 110027",
      embedUrl:
  ...
  return (
    ...
    <div className="container-fluid">
      ...
      <p className="text-center px-lg-5 px-2 mb-5">Discover where we’re proudly serving communities around you.</p>
      <div className="row">
